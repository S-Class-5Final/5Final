...
<<<<<<< HEAD
	...
	public MemberImg(String user_id, String originalFileName, String renameFileName, Date update_date, int imgCount,
			String status) {
		super();
	...
	public String toString() {
		return "MemberImg [user_id=" + user_id + ", originalFileName=" + originalFileName + ", renameFileName="
				+ renameFileName + ", update_date=" + update_date + ", imgCount=" + imgCount + ", status=" + status
				+ "]";
	}
